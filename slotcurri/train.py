...
from slotcurri import configuration, data, metrics, models, utils
...
def main(args, config_overrides=None):
    ...
    # print(ckpt_path)
    # trainer.validate(model=model, datamodule=dataset, ckpt_path=ckpt_path)
    # exit(1)
    import time
    ...
    #
    print(f"Validation step time: {end_time - start_time:.4f} seconds")
